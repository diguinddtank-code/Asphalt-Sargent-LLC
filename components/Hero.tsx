...
export default function Hero() {
  return (
    <section className="relative w-full min-h-[100svh] flex flex-col items-center justify-center pt-20 lg:pt-0 pb-20 lg:pb-0 overflow-hidden">
      {/* Background with Overlay */}
      <div className="absolute inset-0 z-0 bg-neutral-950">
        <Image
          src="https://i.imgur.com/IiWBcFO.png"
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-6 xl:gap-16">
        ...
        <motion.div 
          ...
          className="flex-1 w-full text-left lg:max-w-xl xl:max-w-3xl"
        >
          ...
          <h1 className="font-sans text-5xl sm:text-6xl md:text-7xl lg:text-[clamp(2.75rem,4.5vw,4rem)] xl:text-[clamp(4rem,6vw,6rem)] font-extrabold uppercase leading-[0.9] tracking-tighter mb-4 text-neutral-50 drop-shadow-xl">
            Get a <span className="text-yellow-400 inline-block rotate-[-1deg]">Smooth</span>,<br className="hidden sm:block" />
            <span className="underline decoration-yellow-400 underline-offset-8">Durable</span> Driveway<br className="hidden sm:block lg:hidden xl:block" />
            That Lasts
          </h1>
          
          <p className="text-base sm:text-lg md:text-xl lg:text-[clamp(0.9rem,1.1vw,1.1rem)] xl:text-[clamp(1rem,1.4vw,1.25rem)] text-neutral-300 font-medium mb-8 max-w-2xl border-l-4 border-yellow-400 pl-4 lg:pl-6 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-10 max-w-2xl">
            <a href="#contact" className="group flex-1 flex items-center justify-center gap-2 bg-yellow-400 hover:bg-yellow-300 text-neutral-950 px-6 py-4 lg:py-5 font-extrabold uppercase tracking-widest text-sm lg:text-base transition-all transform hover:-translate-y-1 shadow-[4px_4px_0px_0px_rgba(255,255,255,0.1)] hover:shadow-[6px_6px_0px_0px_rgba(255,255,255,0.2)]">
              Get Free Estimate
              <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
            </a>
            <a href="tel:2483514794" className="flex-1 flex items-center justify-center gap-2 bg-neutral-900/80 backdrop-blur-sm hover:bg-neutral-800 text-neutral-50 px-6 py-4 lg:py-5 font-bold uppercase tracking-widest text-sm lg:text-base transition-colors border border-neutral-700 hover:border-yellow-400">
              <Phone size={20} className="fill-current text-yellow-400" />
              Call (248) 351-4794
            </a>
          </div>
        ...
        >
          ...
          <div className="w-full aspect-[4/5] max-h-[50vh] xl:max-h-[60vh] relative z-10">
            <Image
              src="https://i.imgur.com/EaU9NPc.png"
              alt="Asphalt machinery"
              fill
              className="object-cover relative z-10 hover:brightness-110 transition-all duration-700 shadow-2xl"
