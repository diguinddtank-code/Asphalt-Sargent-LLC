    ...
    <section id="contact" className="py-24 bg-neutral-900 border-t border-neutral-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            <span className="text-orange-500 font-bold tracking-widest uppercase text-sm mb-4 block">Deploy Our Team</span>
            ...
            <div className="space-y-8 mb-12">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:2483514794" className="text-xl text-neutral-300 hover:text-orange-500 transition-colors">(248) 351-4794</a>
                </div>
              </div>
          ...
          <div className="bg-neutral-950 border border-neutral-800 p-8 shadow-2xl relative">
            <div className="absolute top-0 right-0 w-16 h-16 bg-orange-500 translate-x-2 -translate-y-2 -z-10"></div>
            <div className="absolute bottom-0 left-0 w-16 h-16 bg-orange-500 -translate-x-2 translate-y-2 -z-10"></div>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" id="firstName" className="w-full bg-neutral-900 border border-neutral-800 px-4 py-3 text-neutral-50 focus:border-orange-500 focus:outline-none transition-colors" placeholder="John" />
                </div>
                <div>
                  <label htmlFor="lastName" className="block text-xs font-bold text-neutral-400 uppercase tracking-widest mb-2">Last Name</label>
                  <input type="text" id="lastName" className="w-full bg-neutral-900 border border-neutral-800 px-4 py-3 text-neutral-50 focus:border-orange-500 focus:outline-none transition-colors" placeholder="Doe" />
                </div>
              </div>
              
              <div>
                <label htmlFor="phone" className="block text-xs font-bold text-neutral-400 uppercase tracking-widest mb-2">Phone Number</label>
                <input type="tel" id="phone" className="w-full bg-neutral-900 border border-neutral-800 px-4 py-3 text-neutral-50 focus:border-orange-500 focus:outline-none transition-colors" placeholder="(248) 555-0123" />
              </div>
              ...
              <div>
                ...
                <select id="service" className="w-full bg-neutral-900 border border-neutral-800 px-4 py-3 text-neutral-50 focus:border-orange-500 focus:outline-none transition-colors appearance-none">
              ...
              <div>
                ...
                <textarea id="message" rows={4} className="w-full bg-neutral-900 border border-neutral-800 px-4 py-3 text-neutral-50 focus:border-orange-500 focus:outline-none transition-colors resize-none" placeholder="Briefly describe what you need done..."></textarea>
              </div>

              <button type="button" className="w-full bg-orange-500 hover:bg-orange-600 text-neutral-950 font-bold uppercase tracking-widest py-4 transition-all">
                Send Request
              </button>
            </form>
          </div>
